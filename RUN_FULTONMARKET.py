...
parser.add_argument('-s', '--sub-sim-length', default=50, type=int, help="amount of time the simulation needs to be converged according to the mean weighted reduced cartesians of resampled frames. Default is 50, but 25 is recommended. If this is not None, then this criterion will be used over total simulation time (see below).")
...
if __name__ == '__main__':
    ...
    if args.resids_npy is not None:
