...
parser.add_argument('-t', '--total-sim-time', default=None, type=int, help="aggregate simulation time from all replicates in nanoseconds. This criterion is used to evaluate when the simulation is complete and is REQUIRED.")
...
parser.add_argument('-d', '--time-step', default=2.0, type=float, help='Simulation timestep (fs). Default is 2.0 fs.')
